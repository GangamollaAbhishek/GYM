...
export default function CylinderSection() {
  return (
    <section
      id="cylinder-arena"
      className="py-16 bg-[#0B0B0B] border-y border-white/10 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p className="text-[#A0A0A0] text-sm sm:text-base max-w-2xl mx-auto mb-6 font-normal">
          Immerse yourself in our multi-disciplinary training zones engineered
          for raw strength, metabolic output, and kinetic mastery. Drag
          horizontally to spin the arena ring.
        </p>
