...
export const DEFAULT_WORKOUT_SPLITS = {
  ...
  'Upper / Lower Power Split': {
    day1: {
      ...
      exercises: [
        { id: 'ul-1', name: 'Incline Barbell Bench Press', sets: '4 Sets', reps: '6 - 8 Reps', target: '90 kg', rest: '120s' },
        { id: 'ul-2', name: 'Weighted Neutral Pull-ups', sets: '4 Sets', reps: '6 Reps', target: '+20 kg', rest: '90s' },
        { id: 'ul-3', name: 'Standing Overhead Military Press', sets: '4 Sets', reps: '6 - 8 Reps', target: '60 kg', rest: '90s' },
        { id: 'ul-4', name: 'Chest-Supported T-Bar Rows', sets: '4 Sets', reps: '8 - 10 Reps', target: '70 kg', rest: '75s' },
      ]
    },
    day2: {
      title: 'Day 2: Lower Body Kinetic Power',
      focus: 'Quad Overload & Posterior Chain Force Transfer',
      notes: 'Warm up hip flexors and ankle dorsiflexion prior to loading squats.',
      exercises: [
        { id: 'ul-5', name: 'Low Bar Heavy Squats', sets: '5 Sets', reps: '5 Reps', target: '135 kg', rest: '150s' },
        { id: 'ul-6', name: 'Barbell Hip Thrusts', sets: '4 Sets', reps: '8 - 10 Reps', target: '160 kg', rest: '90s' },
        { id: 'ul-7', name: 'Bulgarian Split Squats (Dumbbell)', sets: '3 Sets', reps: '10 Reps/leg', target: '24 kg each', rest: '60s' },
        { id: 'ul-8', name: 'Standing Heavy Calf Raises', sets: '4 Sets', reps: '15 Reps', target: '90 kg', rest: '45s' },
      ]
    },
    day3: {
      ...
      exercises: [
        { id: 'ul-9', name: 'Flat Dumbbell Press', sets: '4 Sets', reps: '10 - 12 Reps', target: '36 kg each', rest: '75s' },
        { id: 'ul-10', name: 'Seated Cable Row (V-Grip)', sets: '4 Sets', reps: '12 Reps', target: '80 kg', rest: '60s' },
        { id: 'ul-11', name: 'Incline Dumbbell Bicep Curls', sets: '3 Sets', reps: '12 - 14 Reps', target: '16 kg', rest: '45s' },
        { id: 'ul-12', name: 'Skull Crushers (EZ-Bar)', sets: '3 Sets', reps: '12 Reps', target: '35 kg', rest: '45s' },
      ]
    },
    day4: {
      title: 'Day 4: Posterior Chain & Hamstring Drive',
      focus: 'Knee Flexion & Glute-Ham Developer Density',
      notes: 'Explode upward from hip hinge without hyperextending lower lumbar spine.',
      exercises: [
        { id: 'ul-13', name: 'Deficit Deadlifts', sets: '4 Sets', reps: '6 Reps', target: '150 kg', rest: '120s' },
        { id: 'ul-14', name: 'Lying Hamstring Leg Curls', sets: '4 Sets', reps: '12 Reps (Slow Negative)', target: '55 kg', rest: '60s' },
        { id: 'ul-15', name: 'Walking Dumbbell Lunges', sets: '3 Sets', reps: '20 Steps', target: '20 kg each', rest: '60s' },
        { id: 'ul-16', name: 'Hanging Windshield Wipers', sets: '3 Sets', reps: '12 Reps', target: 'Bodyweight', rest: '45s' },
      ]
    }
  },
  'Olympic Powerlifting Split': {
    day1: {
      ...
      notes: 'Practice 2-second pause in hole to build tremendous kinetic tension.',
      exercises: [
        { id: 'pl-1', name: 'Competition Barbell Back Squat', sets: '5 Sets', reps: '3 - 5 Reps', target: '140 kg', rest: '180s' },
        { id: 'pl-2', name: 'Pause Squats (2s at Parallel)', sets: '3 Sets', reps: '4 Reps', target: '110 kg', rest: '120s' },
        { id: 'pl-3', name: 'Good Mornings (Safety Squat Bar)', sets: '3 Sets', reps: '8 Reps', target: '65 kg', rest: '90s' },
      ]
    },
    day2: {
      title: 'Day 2: Bench Arch & Tricep Drive',
      focus: 'Competition Bench Press & Lockout Power',
      notes: 'Retract scaps firmly and create aggressive leg drive into platform.',
      exercises: [
        { id: 'pl-4', name: 'Competition Pause Bench Press', sets: '5 Sets', reps: '3 Reps', target: '105 kg', rest: '180s' },
        { id: 'pl-5', name: 'Close-Grip Barbell Bench Press', sets: '4 Sets', reps: '6 - 8 Reps', target: '80 kg', rest: '90s' },
        { id: 'pl-6', name: 'Weighted Dips', sets: '3 Sets', reps: '8 Reps', target: '+25 kg', rest: '90s' },
      ]
    },
    day3: {
      title: 'Day 3: Deadlift Max & Lat Wedge',
      focus: 'Conventional / Sumo Pulling Rigidity',
      notes: 'Pull slack out of bar before breaking the floor. Wedge hips in tight.',
      exercises: [
        { id: 'pl-7', name: 'Competition Deadlift Working Sets', sets: '4 Sets', reps: '2 - 3 Reps', target: '185 kg', rest: '200s' },
        { id: 'pl-8', name: 'Block / Rack Pulls (Below Knee)', sets: '3 Sets', reps: '4 Reps', target: '205 kg', rest: '150s' },
        { id: 'pl-9', name: 'Barbell Shrugs & Holds', sets: '4 Sets', reps: '8 Reps (3s Hold)', target: '130 kg', rest: '75s' },
      ]
    }
  },
  'Full Body Athletic Conditioning': {
    day1: {
      ...
      notes: 'Keep rest strictly under 60 seconds between tri-sets for maximum metabolic conditioning.',
      exercises: [
        { id: 'fb-1', name: 'Trap Bar Deadlifts', sets: '4 Sets', reps: '8 Reps', target: '130 kg', rest: '75s' },
        { id: 'fb-2', name: 'Dumbbell Push Press', sets: '4 Sets', reps: '10 Reps', target: '28 kg each', rest: '60s' },
        { id: 'fb-3', name: 'Kettlebell Goblet Squats', sets: '3 Sets', reps: '15 Reps', target: '32 kg', rest: '45s' },
      ]
    },
    day2: {
      ...
      exercises: [
        { id: 'fb-4', name: '30" Plyometric Box Jumps', sets: '4 Sets', reps: '10 Reps', target: 'Bodyweight', rest: '60s' },
        { id: 'fb-5', name: 'Medicine Ball Rotational Slams', sets: '4 Sets', reps: '15 Reps/side', target: '10 kg Ball', rest: '45s' },
        { id: 'fb-6', name: 'Farmer Carry Walk', sets: '4 Sets', reps: '50 Meters', target: '36 kg/hand', rest: '60s' },
      ]
    },
    day3: {
      ...
      exercises: [
        { id: 'fb-7', name: 'Concept2 Row Sprints (500m Intervals)', sets: '5 Sets', reps: '500m (<1:35 Pace)', target: 'Pace: 1:35', rest: '90s' },
        { id: 'fb-8', name: 'Heavy Prowler Sled Push & Pull', sets: '4 Sets', reps: '40 Meters', target: '100 kg Sled', rest: '60s' },
        { id: 'fb-9', name: 'Plank Shoulder Taps', sets: '3 Sets', reps: '20 Taps', target: 'Bodyweight', rest: '30s' },
      ]
    }
  },
  'Cardio & Metabolic Conditioning': {
    day1: {
      ...
      exercises: [
        { id: 'cm-1', name: 'Incline Dumbbell Press (High Rep)', sets: '4 Sets', reps: '15 - 20 Reps', target: '22 kg each', rest: '45s' },
        { id: 'cm-2', name: 'Push-Up to Renegade Row', sets: '4 Sets', reps: '12 Reps', target: '14 kg each', rest: '45s' },
        { id: 'cm-3', name: 'SkiErg Max Intervals', sets: '5 Sets', reps: '40s Work / 20s Rest', target: 'Max Effort', rest: '45s' },
      ]
    },
    day2: {
      ...
      exercises: [
        { id: 'cm-4', name: 'Kettlebell Double Clean & Squat', sets: '4 Sets', reps: '12 Reps', target: '20 kg each', rest: '45s' },
        { id: 'cm-5', name: 'Jump Lunges', sets: '4 Sets', reps: '20 Reps', target: 'Bodyweight', rest: '30s' },
        { id: 'cm-6', name: 'Echo Bike Mile Sprints', sets: '4 Sets', reps: '1 Mile (<2:15)', target: 'Max Effort', rest: '60s' },
      ]
    }
  }
};
...
export default function TrainerDashboard({ user: propUser, onLogout }) {
  ...
  const [activeTab, setActiveTab] = useState(initialTab === 'notifications' ? 'assigned-customers' : initialTab);
  ...
  const [activeWorkoutForm, setActiveWorkoutForm] = useState({
    ...
    dailySplits: JSON.parse(JSON.stringify(DEFAULT_WORKOUT_SPLITS['Push-Pull-Legs (Hypertrophy)']))
  });
  ...
  const fetchLiveCustomers = async () => {
    ...
    try {
      ...
      if (res.data?.status === 'success' && Array.isArray(res.data?.data)) {
        ...
        const customers = res.data.data.filter(u => u.role === 'customer' || !u.role || u.role === 'member');
        
        // Map genuine data from DB
        const mapped = customers.map((u, idx) => {
          const isAssigned = (u.assignedTrainer && (String(u.assignedTrainer) === String(currentTrainerId))) ||
            (u.assignedTrainerName && u.assignedTrainerName.toLowerCase() === currentTrainerName);
          ...
          return {
            ...
            avatar: u.avatar || `https://images.unsplash.com/photo-${1534528741775 + (idx % 6) * 60}?auto=format&fit=crop&w=300&q=80`,
            ...
            chatMessages: u.chatMessages && u.chatMessages.length > 0 ? u.chatMessages : [
              { sender: 'athlete', senderName: u.name, text: 'Hey Coach! Ready for tomorrow’s heavy deadlift session.', time: '10:15 AM' },
              { sender: 'coach', senderName: user?.name || 'Coach', text: 'Excellent! Make sure to complete the warm-up mobility routine first.', time: '10:20 AM' }
            ]
          };
        });
  ...
  const handleInspectCustomer = (cust, defaultTab = 'workout-plan') => {
    ...
    // Populate form data
    if (cust.workoutPlan) {
      const initialSplits = (cust.workoutPlan.dailySplits && typeof cust.workoutPlan.dailySplits === 'object' && Object.keys(cust.workoutPlan.dailySplits).length > 0)
        ? cust.workoutPlan.dailySplits
        : JSON.parse(JSON.stringify(DEFAULT_WORKOUT_SPLITS[cust.workoutPlan.split || 'Push-Pull-Legs (Hypertrophy)'] || DEFAULT_WORKOUT_SPLITS['Push-Pull-Legs (Hypertrophy)']));
      ...
      setActiveWorkoutForm({
        ...
        cardioProtocol: cust.workoutPlan.cardioProtocol || '20 Mins Incline Treadmill Post-Lift',
        customNotes: cust.workoutPlan.customNotes || 'Focus on explosive concentric cadence and 3s eccentric squats.',
        dailySplits: initialSplits
      });
      setTrainerWorkoutDay(Object.keys(initialSplits)[0] || 'day1');
    } else {
      const defaultSplits = JSON.parse(JSON.stringify(DEFAULT_WORKOUT_SPLITS['Push-Pull-Legs (Hypertrophy)']));
      setActiveWorkoutForm({
        split: 'Push-Pull-Legs (Hypertrophy)',
        frequency: '5 Days / Week',
        intensity: 'High Intensity RPE 8-9',
    ...
    if (cust.dietPlan) {
      setActiveDietForm({
        ...
        mealProtocol: cust.dietPlan.mealProtocol || '4 Meals + 1 Pre-Workout Meal + 1 Post-Workout Whey Shake',
        supplements: Array.isArray(cust.dietPlan.supplements) ? cust.dietPlan.supplements.join(', ') : (cust.dietPlan.supplements || 'Hydrolyzed Whey Isolate, Creatine Creapure')
      });
    }
  ...
  const handleSaveWorkout = async (e) => {
    ...
    try {
      ...
      await api.put(`/api/users/${inspectingCustomer.id}/coaching-data`, payload);
      
      setAllCustomers(prev => prev.map(c => c.id === inspectingCustomer.id ? { ...c, workoutPlan: payload.workoutPlan } : c));
      setInspectingCustomer(prev => ({ ...prev, workoutPlan: payload.workoutPlan }));
      showToast(`✓ Workout Plan saved and pushed to ${inspectingCustomer.name}!`);
    } catch (err) {
  ...
  const handleSaveDiet = async (e) => {
    ...
    if (!inspectingCustomer) return;
    try {
      const suppArray = activeDietForm.supplements.split(',').map(s => s.trim()).filter(Boolean);
      const payload = {
        dietPlan: {
          ...activeDietForm,
      ...
      setAllCustomers(prev => prev.map(c => c.id === inspectingCustomer.id ? { ...c, dietPlan: payload.dietPlan } : c));
      setInspectingCustomer(prev => ({ ...prev, dietPlan: payload.dietPlan }));
  ...
  const handleAddTrainerNote = async (e) => {
    ...
    try {
      ...
      const updatedNotes = [newNoteObj, ...(inspectingCustomer.trainerNotes || [])];
      
      await api.put(`/api/users/${inspectingCustomer.id}/coaching-data`, { trainerNotes: updatedNotes });

      setAllCustomers(prev => prev.map(c => c.id === inspectingCustomer.id ? { ...c, trainerNotes: updatedNotes } : c));
      setInspectingCustomer(prev => ({ ...prev, trainerNotes: updatedNotes }));
      setNewTrainerNote('');
  ...
  const handleSaveProgress = async (e) => {
    ...
    try {
      ...
      setAllCustomers(prev => prev.map(c => c.id === inspectingCustomer.id ? { ...c, progress: payload.progress } : c));
      setInspectingCustomer(prev => ({ ...prev, progress: payload.progress }));
      showToast(`✓ Athlete progression metrics saved for ${inspectingCustomer.name}!`);
    } catch (err) {
  ...
  const filteredCustomers = useMemo(() => {
    return allCustomers.filter(c => {
      const matchesSearch = c.name.toLowerCase().includes(customerSearch.toLowerCase()) ||
        ...
        (c.workoutPlan?.split || '').toLowerCase().includes(customerSearch.toLowerCase());
  ...
  const [coachProfile, setCoachProfile] = useState(() => {
    const saved = localStorage.getItem(`titan_coach_profile_${user?.id || user?._id || 'default'}`);
    if (saved) {
      try { return JSON.parse(saved); } catch (e) {}
    }
    return {
      name: user?.name || 'Master Coach Vikram',
      spec: user?.specialization || 'Master Strength & Olympic Biomechanics Specialist',
      ...
      totalSessions: 1420,
      bio: user?.bio || 'Former national powerlifting champion specialized in velocity-based barbell training, CNS recovery algorithms, and progressive hypertrophy periodization.',
      certifications: ['CSCS Certified', 'IFBB Pro Conditioning', 'Precision Nutrition L2', 'Olympic Weightlifting USAW'],
      certificateFiles: [
        {
          id: 'cert-1',
      ...
      avatar: user?.avatar || 'https://images.unsplash.com/photo-1567013127542-490d757e51fc?auto=format&fit=crop&w=600&q=80'
    };
  });
        ...
        try {
          ...
          if (res.data?.status === 'success' && res.data?.url) {
            ...
            setCoachProfile(prev => {
              ...
              localStorage.setItem(`titan_coach_profile_${user?.id || user?._id || 'default'}`, JSON.stringify(updated));
              return updated;
            });
  ...
  const handleUploadCertificate = async (e) => {
    ...
    let uploadedFileUrl = 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=600&q=80';
    ...
    try {
      if (selectedCertFile?.dataUrl) {
        ...
        if (res.data?.status === 'success' && res.data?.url) {
          ...
          showToast(res.data?.message || 'Warning: Cloudinary upload returned fallback URL');
        }
      }
      ...
      const newCert = {
        ...
        fileName: selectedCertFileName || `${newCertTitle.toLowerCase().replace(/\s+/g, '_')}.pdf`,
      ...
      localStorage.setItem(`titan_coach_profile_${user?.id || user?._id || 'default'}`, JSON.stringify(updatedProfile));

      // Persist to MongoDB
      const targetId = user?.id || user?._id;
      if (targetId) {
        try {
          await api.put(`/api/users/${targetId}`, { certificateFiles: updatedCerts });
        } catch (err) {
      ...
      showToast(`✅ Certificate "${newCert.title}" stored in Cloudinary CDN & verified!`);
    } catch (err) {
      console.error('Cloudinary certificate upload error:', err);
      showToast(err.response?.data?.message || 'Failed to upload certificate to Cloudinary.');
    } finally {
  ...
  const handleDeleteCert = async (certId) => {
    const updatedCerts = (coachProfile.certificateFiles || []).filter(c => c.id !== certId);
    const updatedProfile = { ...coachProfile, certificateFiles: updatedCerts };
    setCoachProfile(updatedProfile);
    setEditProfileForm(updatedProfile);
    localStorage.setItem(`titan_coach_profile_${user?.id || user?._id || 'default'}`, JSON.stringify(updatedProfile));
  ...
  const handleSaveProfile = async (e) => {
    ...
    localStorage.setItem(`titan_coach_profile_${user?.id || user?._id || 'default'}`, JSON.stringify(editProfileForm));
  ...
  const [coachSettings, setCoachSettings] = useState(() => {
    const saved = localStorage.getItem(`titan_coach_settings_${user?.id || 'default'}`);
    if (saved) {
      try { return JSON.parse(saved); } catch (e) {}
    }
    return {
  ...
  const handleSaveSettings = (e) => {
    e.preventDefault();
    localStorage.setItem(`titan_coach_settings_${user?.id || 'default'}`, JSON.stringify(coachSettings));
  ...
  const [dismissedNotifIds, setDismissedNotifIds] = useState(() => {
    try {
      const saved = localStorage.getItem(`titan_dismissed_notifs_${user?.id || user?._id || 'default'}`);
  ...
  const [readNotifIds, setReadNotifIds] = useState(() => {
    try {
      const saved = localStorage.getItem(`titan_read_notifs_${user?.id || user?._id || 'default'}`);
      return saved ? JSON.parse(saved) : [];
    } catch (e) {
      return [];
    }
  ...
  const fetchLiveFeedbacks = async () => {
    try {
      ...
      let apiFeedbacks = [];
      try {
        const res = await api.get(`/feedbacks/trainer/${coachId || user?.name || 'default'}`);
      ...
      localFeedbacks.forEach(lf => {
        if (!combined.some(cf => (cf.id && cf.id === lf.id) || (cf.comment === lf.comment && cf.athleteName === lf.athleteName))) {
          combined.push({
            ...lf,
            id: lf.id || 'fb-' + Math.random(),
            athleteName: lf.athleteName || lf.customerName || 'Gym Athlete',
            athleteAvatar: lf.athleteAvatar || lf.customerAvatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80',
  ...
  useEffect(() => {
    ...
    allCustomers.forEach(cust => {
      ...
      if (!dismissedNotifIds.includes(notifId)) {
        liveNotifs.push({
          ...
          time: cust.createdAt ? new Date(cust.createdAt).toLocaleDateString('en-US', { day: '2-digit', month: 'short' }) : 'Active Member',
    ...
    try {
      const customEvents = JSON.parse(localStorage.getItem('titan_trainer_live_events') || '[]');
  ...
  const markAllNotificationsRead = () => {
    ...
    try {
      localStorage.setItem(`titan_read_notifs_${user?.id || user?._id || 'default'}`, JSON.stringify(updated));
    } catch (e) {}
  ...
  const clearNotification = (id) => {
    ...
    try {
      localStorage.setItem(`titan_dismissed_notifs_${user?.id || user?._id || 'default'}`, JSON.stringify(updated));
    } catch (e) {}
  };
  ...
  const navItems = [
    { id: 'assigned-customers', label: 'View Assigned Customers', icon: Users, badge: `${allCustomers.length}` },
    { id: 'profile', label: 'Profile', icon: Award },
    { id: 'feedbacks', label: 'Feedbacks', icon: Star, badge: `${feedbacks.length}` },
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    <Icon
                      size={16}
                      className={isActive ? 'text-purple-400 drop-shadow-[0_0_8px_rgba(168,85,247,0.7)]' : 'text-slate-400'}
                    />
        ...
        <header className="sticky top-0 z-30 bg-[#0C0E14]/90 backdrop-blur-xl border-b border-white/[0.08] px-6 sm:px-8 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            <h1 className="text-sm sm:text-base font-black text-white uppercase tracking-tight flex items-center gap-2">
              <span className="text-slate-400 font-heading">MASTER COACH HUB</span>
              <span className="text-slate-600">/</span>
              <span className="text-purple-400 font-bold">
                {inspectingCustomer ? `Athlete: ${inspectingCustomer.name}` : editProfileOpen ? 'Edit Profile & Credentials' : (navItems.find(n => n.id === activeTab)?.label || 'Dashboard')}
              </span>
            </h1>
          </div>
          ...
          <div className="flex items-center gap-3">
            <span className="px-3 py-1.5 rounded-xl bg-purple-950/60 border border-purple-800/60 text-purple-300 text-xs font-mono font-semibold hidden sm:flex items-center gap-2 shadow-sm">
              <Clock size={13} className="text-purple-400" /> Duty Shift: {coachProfile.shift.split('(')[0]}
            </span>
                    ...
                    >
                      <div className="flex items-center justify-between pb-3 border-b border-white/[0.08]">
                        <div className="flex items-center gap-2">
                          ...
                          <h3 className="text-sm font-bold text-white font-['Outfit',sans-serif]">Live Alerts</h3>
                          {unreadCount > 0 && (
                        ...
                        {notifications.length > 0 && (
                          ...
                          >
                            <CheckCircle size={12} className="text-emerald-400" /> Mark read
                          </button>
                        )}
                      </div>
                      ...
                      <div className="max-h-96 overflow-y-auto overscroll-contain custom-scrollbar pr-1">
                        {notifications.length === 0 ? (
                          <div className="py-8 text-center space-y-2">
                            ...
                            <p className="text-xs text-slate-400">All caught up! No active alerts.</p>
                          </div>
                        ) : (
                          <PinnedList
                            items={notifications.map(n => ({
                              ...
                              name: n.title,
                              subtitle: n.desc,
                              icon: n.type === 'feedback' ? <Star size={16} className="fill-amber-400 text-amber-400" /> :
                                    n.type === 'checkin' ? <CalendarCheck size={16} /> :
                                    n.type === 'assign' ? <UserCheck size={16} /> :
                                    n.type === 'chat' ? <MessageCircle size={16} /> : <Activity size={16} />,
                              unread: n.unread
                            }))}
                            onItemClick={(item) => {
                              if (item.name?.toLowerCase().includes('review') || item.subtitle?.toLowerCase().includes('review') || item.subtitle?.toLowerCase().includes('star')) {
                                handleTabChange('feedbacks');
                                setNotifDropdownOpen(false);
                              } else if (item.name?.toLowerCase().includes('assigned') || item.name?.toLowerCase().includes('athlete')) {
        ...
        <div className="p-6 sm:p-8 max-w-7xl w-full mx-auto space-y-8 flex-1">
                ...
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-white/[0.08]">
                    ...
                    <span className="px-3.5 py-1.5 rounded-xl bg-purple-950/80 border border-purple-800/80 text-purple-300 text-xs font-mono font-bold">
                      Athlete ID: #{inspectingCustomer.id.slice(-6).toUpperCase()}
                    </span>
                  </div>
                  ...
                  <div className="p-6 sm:p-7 rounded-3xl bg-[#12141C] border border-white/[0.08] shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div className="flex items-center gap-5">
                      ...
                      <div className="space-y-1.5">
                        <div className="flex items-center gap-2.5">
                          <h3 className="text-xl sm:text-2xl font-bold text-white font-['Outfit',sans-serif]">{inspectingCustomer.name}</h3>
                        ...
                        <span className="text-xs sm:text-sm text-purple-400 font-semibold block">{inspectingCustomer.membershipPlan}</span>
                        <div className="flex flex-wrap items-center gap-3 text-xs text-slate-400 pt-0.5">
                          <span className="flex items-center gap-1"><Mail size={12} className="text-slate-500" /> {inspectingCustomer.email}</span>
                          <span className="flex items-center gap-1"><Phone size={12} className="text-slate-500" /> {inspectingCustomer.phone}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-2.5 w-full md:w-auto text-center text-xs">
                      <div className="p-3 rounded-2xl bg-[#090A0E] border border-white/[0.06] min-w-[90px]">
                        ...
                        <span className="font-bold text-white font-mono">{inspectingCustomer.weight}</span>
                      </div>
                      <div className="p-3 rounded-2xl bg-[#090A0E] border border-white/[0.06] min-w-[90px]">
                        <span className="text-[10px] text-slate-400 block">BODY FAT</span>
                        <span className="font-bold text-emerald-400 font-mono">{inspectingCustomer.bodyFat}</span>
                      </div>
                      <div className="p-3 rounded-2xl bg-[#090A0E] border border-white/[0.06] min-w-[90px]">
                        <span className="text-[10px] text-slate-400 block">BLOOD</span>
                        <span className="font-bold text-purple-400 font-mono">{inspectingCustomer.bloodGroup}</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center justify-between pb-4 border-b border-white/[0.06]">
                        <div>
                          <h4 className="text-lg font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                            <Dumbbell size={20} className="text-purple-400" /> Customized Workout Protocol
                          </h4>
                          <p className="text-xs text-slate-400 mt-0.5">Assign periodized hypertrophy, powerlifting splits, and conditioning protocols.</p>
                        </div>
                        <span className="text-[11px] text-slate-400 font-mono">Last update: {inspectingCustomer.workoutPlan?.updatedAt || 'Recently'}</span>
                      </div>

                      <form onSubmit={handleSaveWorkout} className="space-y-6 text-xs">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Primary Training Split Preset</label>
                            <select
                              value={activeWorkoutForm.split}
                              onChange={(e) => {
                                const newSplit = e.target.value;
                                const defaultForSplit = DEFAULT_WORKOUT_SPLITS[newSplit] 
                                  ? JSON.parse(JSON.stringify(DEFAULT_WORKOUT_SPLITS[newSplit]))
                                ...
                                if (defaultForSplit) {
                                  setTrainerWorkoutDay(Object.keys(defaultForSplit)[0] || 'day1');
                                }
                              }}
                            ...
                            >
                              <option value="Push-Pull-Legs (Hypertrophy)">Push-Pull-Legs (5-Day Hypertrophy Split)</option>
                              <option value="Upper / Lower Power Split">Upper / Lower Power Split (4-Day)</option>
                              <option value="Olympic Powerlifting Split">Olympic Powerlifting & Barbell Velocity (3-Day)</option>
                              <option value="Full Body Athletic Conditioning">Full Body Athletic Conditioning (3-Day)</option>
                              <option value="Cardio & Metabolic Conditioning">Cardio & Metabolic Conditioning (2-Day)</option>
                            </select>
                          </div>

                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Weekly Training Frequency</label>
                            <input
                              type="text"
                              value={activeWorkoutForm.frequency}
                              onChange={(e) => setActiveWorkoutForm({ ...activeWorkoutForm, frequency: e.target.value })}
                          ...
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Intensity & Cadence Target</label>
                            <input
                              type="text"
                              value={activeWorkoutForm.intensity}
                              onChange={(e) => setActiveWorkoutForm({ ...activeWorkoutForm, intensity: e.target.value })}
                          ...
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Cardio & Recovery Protocol</label>
                            <input
                              type="text"
                              value={activeWorkoutForm.cardioProtocol}
                              onChange={(e) => setActiveWorkoutForm({ ...activeWorkoutForm, cardioProtocol: e.target.value })}
                        ...
                        <div className="space-y-1.5">
                          <label className="text-slate-300 font-medium">Coach's Technical Cues & Execution Notes</label>
                          <textarea
                            rows={2}
                            value={activeWorkoutForm.customNotes}
                            onChange={(e) => setActiveWorkoutForm({ ...activeWorkoutForm, customNotes: e.target.value })}
                        ...
                        <div className="pt-4 border-t border-white/10 space-y-4">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                            <div>
                              <h5 className="text-sm font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                                <Dumbbell size={16} className="text-purple-400" /> Prescribed Daily Splits & Exercise Routines
                              </h5>
                              <p className="text-[11px] text-slate-400 mt-0.5">Customize daily split names, focus areas, exercises, sets, reps, target weights, and rest periods.</p>
                            </div>
                            
                            <button
                              type="button"
                              onClick={() => {
                                const currentDay = activeWorkoutForm.dailySplits[trainerWorkoutDay];
                                const newEx = {
                                  id: `ex-${Date.now()}`,
                            ...
                            >
                              <Plus size={13} /> Add Exercise to {trainerWorkoutDay.toUpperCase()}
                            </button>
                          </div>

                          {/* Day Tabs */}
                          <div className="flex flex-wrap gap-2">
                            {activeWorkoutForm.dailySplits && Object.keys(activeWorkoutForm.dailySplits).map((dayKey, idx) => (
                              <button
                                key={dayKey}
                                type="button"
                          ...
                          {activeWorkoutForm.dailySplits && activeWorkoutForm.dailySplits[trainerWorkoutDay] && (
                            <div className="p-5 rounded-2xl bg-[#090A0E] border border-white/[0.08] space-y-4 shadow-sm">
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pb-3 border-b border-white/[0.06]">
                                <div className="space-y-1">
                                  <label className="text-[11px] font-semibold text-slate-300">Day Split Title</label>
                                  <input
                                    type="text"
                                    value={activeWorkoutForm.dailySplits[trainerWorkoutDay].title || ''}
                                    onChange={(e) => {
                                      ...
                                      setActiveWorkoutForm(prev => ({
                                        ...
                                        dailySplits: {
                                          ...prev.dailySplits,
                                          [trainerWorkoutDay]: {
                                            ...prev.dailySplits[trainerWorkoutDay],
                                            title: val
                                          }
                                        }
                                      }));
                                ...
                                <div className="space-y-1">
                                  <label className="text-[11px] font-semibold text-slate-300">Biomechanical Focus</label>
                                  <input
                                    type="text"
                                    value={activeWorkoutForm.dailySplits[trainerWorkoutDay].focus || ''}
                                    onChange={(e) => {
                                      const val = e.target.value;
                                      setActiveWorkoutForm(prev => ({
                                        ...prev,
                              ...
                              <div className="space-y-2.5">
                                ...
                                {(!activeWorkoutForm.dailySplits[trainerWorkoutDay].exercises || activeWorkoutForm.dailySplits[trainerWorkoutDay].exercises.length === 0) ? (
                                  <div className="p-4 rounded-xl bg-[#12141C] text-center text-slate-500 text-xs">
                                    No exercises in this split yet. Click "Add Exercise" above to configure movements.
                                  </div>
                                ) : (
                                  activeWorkoutForm.dailySplits[trainerWorkoutDay].exercises.map((ex, exIdx) => (
                                    <div
                                      key={ex.id || exIdx}
                                    ...
                                    >
                                      <div className="flex items-center gap-3 w-full md:w-1/3">
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            const val = e.target.value;
                                            setActiveWorkoutForm(prev => {
                                              const currentDay = prev.dailySplits[trainerWorkoutDay];
                                              const updated = [...(currentDay.exercises || [])];
                                              updated[exIdx] = { ...updated[exIdx], name: val };
                                              return {
                                                ...prev,
                                                dailySplits: { ...prev.dailySplits, [trainerWorkoutDay]: { ...currentDay, exercises: updated } }
                                              };
                                            });
                                          }}
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setActiveWorkoutForm(prev => {
                                              const currentDay = prev.dailySplits[trainerWorkoutDay];
                                              const updated = [...(currentDay.exercises || [])];
                                              updated[exIdx] = { ...updated[exIdx], sets: val };
                                              return {
                                                ...prev,
                                                dailySplits: { ...prev.dailySplits, [trainerWorkoutDay]: { ...currentDay, exercises: updated } }
                                              };
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setActiveWorkoutForm(prev => {
                                              const currentDay = prev.dailySplits[trainerWorkoutDay];
                                              const updated = [...(currentDay.exercises || [])];
                                              updated[exIdx] = { ...updated[exIdx], reps: val };
                                              return {
                                                ...prev,
                                                dailySplits: { ...prev.dailySplits, [trainerWorkoutDay]: { ...currentDay, exercises: updated } }
                                              };
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setActiveWorkoutForm(prev => {
                                              const currentDay = prev.dailySplits[trainerWorkoutDay];
                                              const updated = [...(currentDay.exercises || [])];
                                              updated[exIdx] = { ...updated[exIdx], target: val };
                                              return {
                                                ...prev,
                                                dailySplits: { ...prev.dailySplits, [trainerWorkoutDay]: { ...currentDay, exercises: updated } }
                                              };
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            ...
                                            setActiveWorkoutForm(prev => {
                                              const currentDay = prev.dailySplits[trainerWorkoutDay];
                                              const updated = [...(currentDay.exercises || [])];
                                              updated[exIdx] = { ...updated[exIdx], rest: val };
                                              return {
                                                ...prev,
                                                dailySplits: { ...prev.dailySplits, [trainerWorkoutDay]: { ...currentDay, exercises: updated } }
                                              };
                                      ...
                                      <button
                                        ...
                                        onClick={() => {
                                          setActiveWorkoutForm(prev => {
                                            const currentDay = prev.dailySplits[trainerWorkoutDay];
                                            const updated = currentDay.exercises.filter((_, idx) => idx !== exIdx);
                                            return {
                                              ...prev,
                                              dailySplits: { ...prev.dailySplits, [trainerWorkoutDay]: { ...currentDay, exercises: updated } }
                                            };
                  ...
                  {inspectSubTab === 'diet-plan' && (
                    <div className="p-6 sm:p-8 rounded-3xl bg-[#12141C] border border-white/[0.08] shadow-xl space-y-6 animate-fadeIn">
                      <div className="flex items-center justify-between pb-4 border-b border-white/[0.06]">
                        <div>
                          <h4 className="text-lg font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                            <Utensils size={20} className="text-emerald-400" /> Tailored Macro & Nutrition Protocol
                          </h4>
                          <p className="text-xs text-slate-400 mt-0.5">Configure caloric targets, protein intake, hydration goals, and fuel timing.</p>
                        </div>
                        <span className="text-[11px] text-slate-400 font-mono">Last update: {inspectingCustomer.dietPlan?.updatedAt || 'Recently'}</span>
                      </div>

                      <form onSubmit={handleSaveDiet} className="space-y-5 text-xs">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Daily Caloric Target</label>
                            <input
                              type="text"
                              value={activeDietForm.dailyCalories}
                              onChange={(e) => setActiveDietForm({ ...activeDietForm, dailyCalories: e.target.value })}
                          ...
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Daily Protein Intake</label>
                            <input
                              type="text"
                              value={activeDietForm.protein}
                              onChange={(e) => setActiveDietForm({ ...activeDietForm, protein: e.target.value })}
                          ...
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Daily Hydration Target</label>
                            <input
                              type="text"
                              value={activeDietForm.waterIntake}
                              onChange={(e) => setActiveDietForm({ ...activeDietForm, waterIntake: e.target.value })}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Meal Timing Schedule & Protocol</label>
                            <textarea
                              rows={3}
                              value={activeDietForm.mealProtocol}
                              onChange={(e) => setActiveDietForm({ ...activeDietForm, mealProtocol: e.target.value })}
                          ...
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Recommended Supplementation Stack</label>
                            <textarea
                              rows={3}
                              value={activeDietForm.supplements}
                              onChange={(e) => setActiveDietForm({ ...activeDietForm, supplements: e.target.value })}
                  ...
                  {inspectSubTab === 'trainer-notes' && (
                    <div className="p-6 sm:p-8 rounded-3xl bg-[#12141C] border border-white/[0.08] shadow-xl space-y-6 animate-fadeIn">
                      <div className="pb-4 border-b border-white/[0.06]">
                        <h4 className="text-lg font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                          <NotebookPen size={20} className="text-purple-400" /> Coach Observation & Form Audit Notes
                        </h4>
                        <p className="text-xs text-slate-400 mt-0.5">Private coach logs on athlete progression, movement restrictions, and recovery status.</p>
                      </div>

                      <form onSubmit={handleAddTrainerNote} className="space-y-2 text-xs">
                        <label className="text-slate-300 font-medium">Log New Observation / Audit Entry</label>
                      ...
                      <div className="space-y-3 pt-2">
                        <h5 className="text-xs font-bold text-white uppercase tracking-wider font-mono">CHRONOLOGICAL COACH LOGS</h5>
                        {(!inspectingCustomer.trainerNotes || inspectingCustomer.trainerNotes.length === 0) ? (
                          <div className="p-6 rounded-2xl bg-[#090A0E] text-center text-slate-400 text-xs">
                            No trainer notes logged yet. Use the field above to log your first observation.
                          </div>
                        ) : (
                          inspectingCustomer.trainerNotes.map((n, i) => (
                            <div key={i} className="p-4 sm:p-5 rounded-2xl bg-[#090A0E] border border-white/[0.06] space-y-1.5 text-xs">
                              <div className="flex justify-between items-center">
                                <span className="font-bold text-purple-400 font-mono">{n.author || 'Master Coach'}</span>
                  ...
                  {inspectSubTab === 'progress' && (
                    <div className="p-6 sm:p-8 rounded-3xl bg-[#12141C] border border-white/[0.08] shadow-xl space-y-6 animate-fadeIn">
                      <div className="flex items-center justify-between pb-4 border-b border-white/[0.06]">
                        <div>
                          <h4 className="text-lg font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                            <LineChart size={20} className="text-purple-400" /> Athlete Biometrics & 1RM PR Telemetry
                          </h4>
                          <p className="text-xs text-slate-400 mt-0.5">Track compound 1-Rep-Max strength records, body composition changes, and workout volume.</p>
                        </div>
                        <span className="text-[11px] text-slate-400 font-mono">Last audit: {inspectingCustomer.progress?.lastAuditDate || 'Recently'}</span>
                      </div>

                      <form onSubmit={handleSaveProgress} className="space-y-6 text-xs">
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                          <div className="p-5 rounded-2xl bg-[#090A0E] border border-white/5 space-y-2">
                            <label className="text-slate-400 font-semibold uppercase tracking-wider text-[11px] block">BENCH PRESS 1RM</label>
                            <input
                              type="text"
                              value={activeProgressForm.benchPressPR}
                              onChange={(e) => setActiveProgressForm({ ...activeProgressForm, benchPressPR: e.target.value })}
                          ...
                          <div className="p-5 rounded-2xl bg-[#090A0E] border border-white/5 space-y-2">
                            <label className="text-slate-400 font-semibold uppercase tracking-wider text-[11px] block">BACK SQUAT 1RM</label>
                            <input
                              type="text"
                              value={activeProgressForm.squatPR}
                              onChange={(e) => setActiveProgressForm({ ...activeProgressForm, squatPR: e.target.value })}
                              className="w-full px-4 py-2.5 rounded-xl bg-[#12141C] border border-white/10 text-white font-mono text-base outline-none focus:border-purple-500"
                            />
                          </div>

                          <div className="p-5 rounded-2xl bg-[#090A0E] border border-white/5 space-y-2">
                            <label className="text-slate-400 font-semibold uppercase tracking-wider text-[11px] block">DEADLIFT 1RM</label>
                            <input
                              type="text"
                              value={activeProgressForm.deadliftPR}
                              onChange={(e) => setActiveProgressForm({ ...activeProgressForm, deadliftPR: e.target.value })}
                              className="w-full px-4 py-2.5 rounded-xl bg-[#12141C] border border-white/10 text-white font-mono text-base outline-none focus:border-purple-500"
                            />
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Current Body Weight</label>
                            <input
                              type="text"
                              value={activeProgressForm.currentWeight}
                              onChange={(e) => setActiveProgressForm({ ...activeProgressForm, currentWeight: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#090A0E] border border-white/10 text-white text-xs outline-none focus:border-purple-500"
                            />
                          </div>

                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Target Goal Weight</label>
                            <input
                              type="text"
                              value={activeProgressForm.targetWeight}
                              onChange={(e) => setActiveProgressForm({ ...activeProgressForm, targetWeight: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#090A0E] border border-white/10 text-white text-xs outline-none focus:border-purple-500"
                            />
                          </div>

                          <div className="space-y-1.5">
                            <label className="text-slate-300 font-medium">Body Fat Percentage</label>
                            <input
                              type="text"
                              value={activeProgressForm.bodyFat}
                              onChange={(e) => setActiveProgressForm({ ...activeProgressForm, bodyFat: e.target.value })}
                              className="w-full px-4 py-3 rounded-xl bg-[#090A0E] border border-white/10 text-white text-xs outline-none focus:border-purple-500"
                            />
                          </div>
                        </div>
                  ...
                  {inspectSubTab === 'chat' && (
                    <div className="p-6 sm:p-8 rounded-3xl bg-[#12141C] border border-white/[0.08] shadow-xl space-y-4 animate-fadeIn">
                      <div className="flex items-center justify-between pb-3 border-b border-white/[0.06]">
                        <div>
                          <h4 className="text-lg font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                            <MessageSquare size={20} className="text-purple-400" /> 1-on-1 Coach & Athlete Advisory Channel
                          </h4>
                          <p className="text-xs text-slate-400 mt-0.5">Send direct workout feedback, video critique, and schedule updates to {inspectingCustomer.name}.</p>
                        </div>
                      ...
                      <div className="flex flex-col h-[480px] rounded-2xl bg-[#090A0E] border border-white/10 overflow-hidden">
                        <div className="flex-1 p-5 overflow-y-auto custom-scrollbar space-y-3">
                          {chatMessages.length === 0 ? (
                            <div className="h-full flex items-center justify-center text-slate-500 text-xs">
                              No previous chat messages with this athlete. Send an advisory below to start communication.
                            </div>
                          ) : (
                        ...
                        <form onSubmit={handleSendChat} className="p-3 bg-[#12141C] border-t border-white/10 flex items-center gap-2">
                          <input
                            type="text"
                            value={chatInput}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-white/[0.08]">
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-slate-400 mt-1">
                        Live registered members from database. Click any athlete to open their dedicated <strong>Workout Plan</strong>, <strong>Diet Plan</strong>, <strong>Trainer Notes</strong>, <strong>Progress Tracking</strong>, and <strong>1-on-1 Chat</strong> section.
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <span className="px-3.5 py-1.5 rounded-xl bg-purple-950/60 border border-purple-800 text-purple-300 text-xs font-mono font-bold flex items-center gap-1.5">
                        <UserCheck size={14} className="text-purple-400" /> {allCustomers.length} Total Athletes in DB
                      </span>
                    </div>
                  </div>
                  ...
                  {loading ? (
                    <div className="p-12 rounded-3xl bg-[#12141C] border border-white/[0.08] text-center text-slate-400 text-xs font-mono">
                      Connecting to MongoDB and fetching genuine athlete roster...
                    </div>
                    ...
                    <div className="p-12 rounded-3xl bg-[#12141C] border border-white/[0.08] text-center space-y-3">
                      ...
                      <h3 className="text-base font-bold text-white">No Athletes Found in Database</h3>
                      <p className="text-xs text-slate-400">No registered customers match your search query.</p>
                    </div>
                  ) : (
                          ...
                          <div className="space-y-3.5">
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center text-xs">
                              <div className="p-2.5 rounded-xl bg-[#090A0E] border border-white/[0.04]">
                                <span className="text-[10px] text-slate-400 block">WEIGHT</span>
                                <span className="font-bold text-white font-mono">{cust.weight}</span>
                              </div>
                              <div className="p-2.5 rounded-xl bg-[#090A0E] border border-white/[0.04]">
                                <span className="text-[10px] text-slate-400 block">BODY FAT</span>
                                <span className="font-bold text-emerald-400 font-mono">{cust.bodyFat}</span>
                              </div>
                              <div className="p-2.5 rounded-xl bg-[#090A0E] border border-white/[0.04]">
                                <span className="text-[10px] text-slate-400 block">ADHERENCE</span>
                                <span className="font-bold text-purple-400 font-mono">{cust.progress?.weeklyAttendanceScore || '96%'}</span>
                              </div>
                            </div>
                            ...
                            <div className="p-3.5 rounded-2xl bg-[#090A0E] border border-white/[0.04] space-y-1.5 text-xs">
                              <div className="flex justify-between items-center text-slate-400">
                                ...
                                <span className="text-white font-semibold truncate max-w-[140px]">{cust.workoutPlan?.split || 'Push-Pull-Legs'}</span>
                              </div>
                              <div className="flex justify-between items-center text-slate-400">
                                <span>Phone:</span>
                              ...
                              <div className="flex justify-between items-center text-slate-400 truncate">
                                <span>Email:</span>
                                <span className="text-slate-300 truncate max-w-[140px]">{cust.email}</span>
                              </div>
                            </div>
                          </div>
              ...
              {editProfileOpen ? (
                <div className="space-y-6 animate-fadeIn">
                  ...
                  <div className="flex items-center justify-between pb-4 border-b border-white/[0.08]">
                    ...
                    <span className="text-xs text-purple-400 font-mono font-bold">Faculty Credentials Editor</span>
                  </div>
                  ...
                  <div className="p-6 sm:p-8 rounded-3xl bg-[#12141C] border border-purple-500/40 shadow-xl space-y-6">
                    <div className="flex items-center gap-3 pb-4 border-b border-white/10">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-white font-['Outfit',sans-serif]">Edit Coach Profile Details</h3>
                        <p className="text-xs text-slate-400">Update your biographical info, shift hours, coaching arena, and upload new avatar photo.</p>
                      </div>
                    </div>
                    ...
                    <form onSubmit={handleSaveProfile} className="space-y-6 text-xs">
                      ...
                      <div className="p-5 rounded-2xl bg-[#090A0E] border border-white/[0.06] flex flex-col sm:flex-row items-center gap-5">
                        ...
                        <div className="flex-1 space-y-2 text-center sm:text-left">
                          ...
                          <p className="text-xs text-slate-400">Upload a high-resolution headshot from your device or specify an image URL.</p>
                          ...
                          <div className="flex flex-wrap gap-2 pt-1 justify-center sm:justify-start">
                            ...
                            >
                              <Upload size={13} /> {isUploadingAvatar ? 'Uploading to Cloudinary CDN...' : 'Select Image from Computer'}
                            </button>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="space-y-1.5">
                          <label className="text-slate-300 font-medium">Coach Full Name</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-slate-300 font-medium">Specialization & Role Title</label>
                          <input
                            type="text"
                            value={editProfileForm.spec}
                            onChange={(e) => setEditProfileForm({ ...editProfileForm, spec: e.target.value })}
                            className="w-full px-4 py-3 rounded-xl bg-[#090A0E] border border-white/10 text-white text-xs outline-none focus:border-purple-500"
                            required
                          />
                        </div>
                        ...
                        <div className="space-y-1.5">
                          <label className="text-slate-300 font-medium">Duty Shift Hours</label>
                          <input
                            type="text"
                        ...
                        <div className="space-y-1.5">
                          <label className="text-slate-300 font-medium">Primary Coaching Arena</label>
                          <input
                            type="text"
                            value={editProfileForm.room}
                            onChange={(e) => setEditProfileForm({ ...editProfileForm, room: e.target.value })}
                            className="w-full px-4 py-3 rounded-xl bg-[#090A0E] border border-white/10 text-white text-xs outline-none focus:border-purple-500"
                          />
                        </div>
                      ...
                      <div className="space-y-1.5">
                        <label className="text-slate-300 font-medium">Coaching Philosophy & Biography</label>
                        <textarea
                          rows={4}
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-4 border-b border-white/[0.08]">
                    <div>
                      <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight font-['Outfit',sans-serif]">Master Coach Profile & Credentials</h2>
                      <p className="text-xs sm:text-sm text-slate-400 mt-1">Official faculty biographical data, active certifications, shift telemetry, and document credentials.</p>
                    </div>
                    <button
                      onClick={() => {
                  ...
                  <div className="p-6 sm:p-8 rounded-3xl bg-[#12141C] border border-white/[0.08] shadow-xl space-y-6">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-white/[0.06]">
                      <div className="flex items-center gap-5">
                        ...
                        <div className="space-y-1.5">
                          <div className="flex items-center gap-2.5">
                            <h3 className="text-xl sm:text-2xl font-bold text-white font-['Outfit',sans-serif]">{coachProfile.name}</h3>
                          ...
                          <span className="text-xs sm:text-sm text-purple-400 font-semibold block">{coachProfile.spec}</span>
                          <span className="text-xs text-slate-400 block">{coachProfile.experience} • Duty Shift: {coachProfile.shift}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                        <div className="p-3.5 rounded-2xl bg-[#090A0E] border border-white/5 text-center min-w-[120px]">
                          <div className="text-xl font-bold text-amber-400 font-mono flex items-center justify-center gap-1">
                            <Star size={16} className="fill-amber-400 text-amber-400" /> {coachProfile.rating}
                          </div>
                          <span className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Faculty Rating</span>
                        </div>
                        <div className="p-3.5 rounded-2xl bg-[#090A0E] border border-white/5 text-center min-w-[120px]">
                          <div className="text-xl font-bold text-white font-mono">{coachProfile.totalSessions}+</div>
                          <span className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">Sessions Run</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                      <div className="p-4 rounded-2xl bg-[#090A0E] border border-white/5 space-y-1">
                        ...
                        <p className="font-semibold text-white">{coachProfile.room}</p>
                      </div>
                      <div className="p-4 rounded-2xl bg-[#090A0E] border border-white/5 space-y-1">
                        <span className="text-slate-400 uppercase tracking-wider text-[10px] font-semibold block">COACH EMAIL:</span>
                        <p className="font-semibold text-slate-300 truncate">{coachProfile.email}</p>
                      </div>
                      <div className="p-4 rounded-2xl bg-[#090A0E] border border-white/5 space-y-1">
                        <span className="text-slate-400 uppercase tracking-wider text-[10px] font-semibold block">COACH PHONE:</span>
                        <p className="font-semibold text-slate-300 font-mono">{coachProfile.phone}</p>
                      </div>
                    </div>

                    <div className="space-y-2">
                      <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono">COACHING PHILOSOPHY & BIO</h4>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-4 border-b border-white/[0.06]">
                      <div>
                        <h3 className="text-lg font-bold text-white font-['Outfit',sans-serif] flex items-center gap-2">
                          <FileCheck size={20} className="text-purple-400" /> Accredited Certificates & File Credentials
                        </h3>
                        <p className="text-xs text-slate-400 mt-0.5">Upload, manage, and verify official faculty certifications, degrees, and licenses.</p>
                      </div>
                      <span className="px-3 py-1 rounded-full bg-purple-950/80 text-purple-300 border border-purple-800 text-xs font-mono font-semibold">
                        {(coachProfile.certificateFiles || []).length} Verified Documents
                      </span>
                    </div>

                    {/* Upload New Certificate Form */}
                    <form onSubmit={handleUploadCertificate} className="p-5 rounded-2xl bg-[#090A0E] border border-purple-500/20 space-y-4 text-xs">
                      <div className="flex items-center gap-2">
                        <Upload size={16} className="text-purple-400" />
                        <h4 className="text-xs font-bold text-white uppercase tracking-wider font-mono">Upload New Certificate Document</h4>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-1.5 sm:col-span-1">
                          <label className="text-slate-300 font-medium">Issuing Academy / Board</label>
                          <input
                            type="text"
                            value={newCertIssuer}
                        ...
                        <div className="space-y-1.5 sm:col-span-1">
                          <label className="text-slate-300 font-medium">Issue Year</label>
                          <input
                            type="text"
                            value={newCertDate}
                      ...
                      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-1">
                        ...
                        >
                          ...
                          <span>{selectedCertFileName ? `File: ${selectedCertFileName}` : 'Choose File (PDF or Image)'}</span>
                        </button>
                        ...
                        >
                          <Plus size={15} /> {isUploadingCert ? 'Uploading to Cloudinary CDN...' : 'Upload & Add to Credentials'}
                        </button>
                      </div>
                    </form>
                        ...
                        >
                          <div className="space-y-2">
                            ...
                            <div>
                              ...
                              <p className="text-[11px] text-slate-400 mt-0.5 line-clamp-1">{cert.issuer}</p>
                            </div>
          ...
          {activeTab === 'notifications' && (
            <div className="space-y-6 animate-fadeIn">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-4 border-b border-white/[0.08]">
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight font-['Outfit',sans-serif]">Live Alerts & Notifications</h2>
                  <p className="text-xs sm:text-sm text-slate-400 mt-1">Real-time gym floor telemetry, athlete check-ins, routine review requests, and management notices.</p>
                </div>
                {unreadCount > 0 && (
                  <button
                    onClick={markAllNotificationsRead}
                  ...
                  >
                    <CheckCircle size={14} className="text-emerald-400" /> Mark All as Read
                  </button>
                )}
              </div>
              ...
              {notifications.length === 0 ? (
                <div className="p-12 rounded-3xl bg-[#12141C] border border-white/[0.08] text-center space-y-3">
                  ...
                  <p className="text-xs text-slate-400">No new alerts or telemetry notifications at this time.</p>
                </div>
              ) : (
                    ...
                    >
                      <div className="flex items-start gap-3.5">
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
                          notif.type === 'feedback' ? 'bg-amber-500/10 text-amber-400 border border-amber-500/20' :
                          notif.type === 'checkin' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' :
                          notif.type === 'audit' ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20' :
                          notif.type === 'assign' ? 'bg-purple-500/10 text-purple-400 border border-purple-500/20' :
                          'bg-cyan-500/10 text-cyan-400 border border-cyan-500/20'
                        }`}>
                          {notif.type === 'feedback' ? <Star size={18} className="fill-amber-400 text-amber-400" /> :
                           notif.type === 'checkin' ? <CalendarCheck size={18} /> :
                           notif.type === 'audit' ? <Award size={18} /> :
                           notif.type === 'assign' ? <UserCheck size={18} /> : <Activity size={18} />}
                        </div>
                        <div className="space-y-1">
                          <div className="flex items-center gap-2">
                            <h4 className="text-sm font-bold text-white font-['Outfit',sans-serif]">{notif.title}</h4>
                            {notif.unread && (
          ...
          {activeTab === 'feedbacks' && (
            <div className="space-y-6 animate-fadeIn">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-4 border-b border-white/[0.08]">
                <div>
                  <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight font-['Outfit',sans-serif]">Athlete Reviews & Performance Feedback</h2>
                  <p className="text-xs sm:text-sm text-slate-400 mt-1">Verified member ratings, performance audit feedback, and coach responsiveness scores.</p>
                </div>
                <div className="flex items-center gap-2">
                  <span className="px-3.5 py-1.5 rounded-xl bg-amber-500/10 text-amber-300 border border-amber-500/20 text-xs font-semibold flex items-center gap-1.5">
                    <Star size={13} className="fill-amber-400 text-amber-400" /> Overall Rating: {
                      feedbacks.length > 0 
              ...
              <div className="space-y-4">
                {feedbacks.length === 0 ? (
                  <div className="p-10 sm:p-14 rounded-3xl bg-[#12141C] border border-white/[0.08] text-center space-y-3 shadow-sm">
                    ...
                    <h4 className="text-base font-bold text-white font-['Outfit',sans-serif]">No Athlete Feedbacks Logged Yet</h4>
                    <p className="text-xs text-slate-400 max-w-md mx-auto leading-relaxed">
                      When your assigned members submit coaching reviews, ratings, and feedback from their portal, their live reviews will appear here in real time.
                    </p>
                  </div>
                ) : (
                  feedbacks.map((fb) => {
                    const matchedCustomer = allCustomers.find(c => 
                      ...
                      (c.name && fb.athleteName && c.name.toLowerCase().trim() === fb.athleteName.toLowerCase().trim())
                    );
                    const athleteImg = matchedCustomer?.avatar || fb.athleteAvatar || fb.customerAvatar || 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&q=80';
                    const athletePlan = matchedCustomer?.plan || fb.plan || fb.customerPlan || 'VIP Athlete Member';

                    return (
                    <div key={fb.id} className="p-5 sm:p-6 rounded-3xl bg-[#12141C] border border-white/[0.08] space-y-4 shadow-sm">
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-white/[0.04]">
                        <div className="flex items-center gap-3">
                          ...
                          />
                          <div>
                            <h4 className="text-sm font-bold text-white font-['Outfit',sans-serif]">{fb.athleteName}</h4>
                            <span className="text-[11px] text-purple-400 font-mono">{athletePlan}</span>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="flex items-center gap-1">
                            {[...Array(5)].map((_, i) => (
                              <Star
                                key={i}
                                size={13}
                                className={i < fb.rating ? 'fill-amber-400 text-amber-400' : 'text-slate-600'}
                              />
                            ))}
                          </div>
                      ...
                      {fb.reply ? (
                        <div className="p-3.5 rounded-2xl bg-[#090A0E] border border-purple-500/20 space-y-1">
                          <div className="flex items-center gap-1.5 text-xs font-bold text-purple-400">
                            <MessageCircle size={13} /> {fb.replyAuthor || user?.name || 'Coach'}'s Reply:
                          </div>
                          <p className="text-xs text-slate-300 italic">{fb.reply}</p>
                        </div>
                      ) : (
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6 animate-fadeIn max-w-3xl">
              <div className="pb-4 border-b border-white/[0.08]">
                <h2 className="text-xl sm:text-2xl font-bold text-white tracking-tight font-['Outfit',sans-serif]">Coach Configuration & Preferences</h2>
                <p className="text-xs sm:text-sm text-slate-400 mt-1">Configure your duty shifts, notification routing, arena preferences, and platform security.</p>
              </div>
                ...
                <div className="p-6 rounded-3xl bg-[#12141C] border border-white/[0.08] space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider font-mono flex items-center gap-2">
                      <Clock size={16} className="text-purple-400" /> Shift & Floor Location
                    </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                    <div className="p-4 rounded-2xl bg-[#090A0E] border border-white/5 space-y-2">
                      <div className="flex items-center justify-between text-slate-400">
                        <span className="font-semibold uppercase tracking-wider text-[10px]">ASSIGNED DUTY SHIFT</span>
                      ...
                      <div className="flex items-center gap-2.5 text-white font-bold text-sm">
                        ...
                        <span>{user?.shift || coachSettings.dutyShift || '06:00 AM - 02:00 PM (Morning Roster)'}</span>
                      </div>
                      <span className="text-[10px] text-slate-500 font-mono block">Weekly Active Schedule: Mon - Sat</span>
                    </div>

                    <div className="p-4 rounded-2xl bg-[#090A0E] border border-white/5 space-y-2">
                      <div className="flex items-center justify-between text-slate-400">
                        <span className="font-semibold uppercase tracking-wider text-[10px]">PRIMARY COACHING ARENA</span>
                        <span className="text-[10px] text-purple-400 font-mono flex items-center gap-1">
                          <Lock size={9} /> Admin Provisioned
                        </span>
                      </div>
                      <div className="flex items-center gap-2.5 text-white font-bold text-sm">
                        ...
                        <span>{user?.assignedRoom || coachSettings.arenaZone || 'Zone 1: Olympic Heavy Platform'}</span>
                      </div>
                      <span className="text-[10px] text-slate-500 font-mono block">Designated Training Floor & Rig</span>
                    </div>
                  </div>
                  ...
                  <div className="p-3.5 rounded-2xl bg-purple-950/20 border border-purple-900/30 flex items-center gap-2.5 text-xs text-purple-300/90">
                    ...
                    <span>Shift rosters and floor zone allocations are configured centrally by Admin HQ. Contact management to request a shift adjustment.</span>
                  </div>
                </div>

                <div className="p-6 rounded-3xl bg-[#12141C] border border-white/[0.08] space-y-4">
                  <h3 className="text-sm font-bold text-white uppercase tracking-wider font-mono flex items-center gap-2">
                    <Bell size={16} className="text-purple-400" /> Notifications & Telemetry Triggers
                  </h3>
                  ...
                  <div className="space-y-3 text-xs">
                    <label className="flex items-center justify-between p-3.5 rounded-2xl bg-[#090A0E] border border-white/[0.04] cursor-pointer">
                      <div>
                        <span className="font-semibold text-white block">Athlete Check-In Instant Alerts</span>
                        <span className="text-slate-400 text-[11px]">Receive notification when an assigned athlete scans into your arena</span>
                      </div>
                      <input
                        type="checkbox"
                        checked={coachSettings.biometricAlerts}
                        onChange={(e) => setCoachSettings({ ...coachSettings, biometricAlerts: e.target.checked })}
                    ...
                    <label className="flex items-center justify-between p-3.5 rounded-2xl bg-[#090A0E] border border-white/[0.04] cursor-pointer">
                      <div>
                        <span className="font-semibold text-white block">Auto-Remind Workout Logs</span>
                        <span className="text-slate-400 text-[11px]">Send automated push reminders to athletes who haven't logged today's sets</span>
                      </div>
                      <input
                        type="checkbox"
                        checked={coachSettings.autoRemindWorkoutLogs}
                        onChange={(e) => setCoachSettings({ ...coachSettings, autoRemindWorkoutLogs: e.target.checked })}
                        className="w-4 h-4 accent-purple-600 rounded cursor-pointer"
                      />
                    </label>
                  </div>
          ...
          <div className="relative w-full max-w-2xl bg-[#12141C] rounded-3xl border border-purple-500/50 shadow-2xl p-6 sm:p-7 space-y-4 max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-white font-['Outfit',sans-serif]">{viewingCertificateFile.title}</h3>
                  <p className="text-xs text-purple-400 font-mono">{viewingCertificateFile.issuer} • Issued {viewingCertificateFile.issueDate}</p>
                </div>
              </div>
              <button
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-3 rounded-2xl bg-[#08090D] border border-white/10 flex items-center justify-center min-h-[300px]">
              {viewingCertificateFile.fileUrl?.startsWith('data:application/pdf') ? (
                <iframe
                ...
                <img
                  src={viewingCertificateFile.fileUrl || 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&q=80'}
              ...
              <div className="flex items-center gap-2">
                {viewingCertificateFile.fileUrl && (
                  <a
                    ...
                    download={viewingCertificateFile.fileName || 'certificate_document'}
