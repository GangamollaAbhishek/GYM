...
export function TrainerCardDeck({
  ...
  const defaultTrainers = [
    {
      ...
      description:
        "IFBB Pro & Master Strength Coach with 14+ years of elite athletic programming. Specialized in maximal hypertrophy, mechanical load optimization, and contest preparation.",
      image:
    ...
    },
    {
      ...
      description:
        "Ex-Olympic Gymnast & CSCS Mobility Specialist. Master of high-velocity HIIT conditioning, biomechanical alignment, and functional athletic endurance.",
      image:
    ...
    },
    {
      ...
      description:
        "Pro Muay Thai Fighter & Tactical Conditioning Specialist. Focuses on explosive rotational power, metabolic energy system development, and extreme mental toughness.",
      image:
    ...
    },
    {
      ...
      description:
        "Precision Nutrition Coach & Powerlifting Champion. Expert in personalized macronutrient partitioning, biomechanical squat mechanics, and body recomposition.",
      image:
  ...
  return (
    <section
      id="trainers-deck"
      className="py-24 bg-[#0B0B0B] border-t border-white/10 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center mb-12">
        ...
        <h2 className="font-bebas text-5xl sm:text-6xl md:text-7xl text-white tracking-wider uppercase mb-3 drop-shadow-[0_4px_20px_rgba(0,0,0,0.8)]">
          MEET THE{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E50914] via-[#FF2B35] to-[#E50914]">
            TITAN PULSE TRAINERS{" "}
          </span>
        </h2>

        <p className="text-[#A0A0A0] text-sm sm:text-base max-w-2xl mx-auto font-normal">
          World-class IFBB professionals, CSCS specialists, and combat master
          trainers dedicated to elevating your physical threshold.
        </p>
      </div>

      {/* 3D Stacked Card Container */}
      <div
        className={`flex items-center justify-center p-4 sm:p-8 ${className || ""}`}
      >
        <div
