...
import { Dumbbell, ArrowUp, Send, Instagram, Youtube, Twitter, Facebook, Linkedin, Sparkles } from 'lucide-react';
    ...
    >
      ...
      <AnimatePresence>
        {isHovered && (
          ...
          >
            ...
            <div 
              className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 rotate-45 bg-[#12161E] border-r border-b border-white/20" 
            />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        ...
        <div 
          ...
          style={{ background: item.color, boxShadow: `0 0 25px ${item.shadow}` }}
        />
        ...
        {/* Button Base Body */}
        <div 
          className="relative w-full h-full rounded-2xl bg-[#12161A] border border-white/10 group-hover:border-transparent flex items-center justify-center overflow-hidden transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]"
        >
