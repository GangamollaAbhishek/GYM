...
export default function CylinderDrag3D() {
    ...
    const images = [
        ...
        { src: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=700&q=80', title: 'POWERLIFTING ARENA' },
        { src: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?auto=format&fit=crop&w=700&q=80', title: 'HYPERTROPHY LAB' },
        { src: 'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?auto=format&fit=crop&w=700&q=80', title: 'HIIT BLAST DECK' },
        { src: 'https://images.unsplash.com/photo-1549719386-74dfcbf7dbed?auto=format&fit=crop&w=700&q=80', title: 'COMBAT STRIKE' },
        { src: 'https://images.unsplash.com/photo-1574680096145-d05b474e2155?auto=format&fit=crop&w=700&q=80', title: 'ARMORY BENCH' },
        { src: 'https://images.unsplash.com/photo-1517963879433-6ad2b056d712?auto=format&fit=crop&w=700&q=80', title: 'CALISTHENICS RACK' },
        { src: 'https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?auto=format&fit=crop&w=700&q=80', title: 'OLYMPIC PLATFORM' }
    ];
    ...
    useEffect(() => {
        ...
        dragger.addEventListener('touchstart', handlePointerDown, { passive: true });
                    ...
                    {images.map((item, i) => (
                        <div key={i} className="ring-img">
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-black via-black/70 to-transparent text-left pointer-events-none">
                                <span className="font-bebas text-lg text-white tracking-wider block">{item.title}</span>
                                <span className="text-[10px] uppercase font-mono text-[#E50914] tracking-widest block">ZONE 0{i+1}</span>
                            </div>
                        </div>
                    ))}
                </div>
