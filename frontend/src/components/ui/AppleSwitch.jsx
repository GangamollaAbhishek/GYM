...
const AppleSwitch = forwardRef(
  (
    ...
    const currentChecked = checked !== undefined ? checked : uncontrolledChecked;
    ...
    const switchEl = (
      <button
        ...
        className={cn(
          "relative inline-flex shrink-0 cursor-pointer items-center rounded-full active:cursor-grabbing select-none",
          "border border-white/20 bg-black/50 shadow-inner backdrop-blur-md transition-opacity",
      ...
      >
        ...
        <span className="absolute inset-0 overflow-hidden rounded-full">
          <span
            ...
            style={{
              ...
              boxShadow:
                "inset 0 1px 1px rgba(255,255,255,0.2), inset 0 -1px 2px rgba(0,0,0,0.4)",
            }}
          />
        ...
        <motion.span
          ...
          style={{
            ...
            boxShadow:
              "0 3px 11px rgba(0,0,0,0.35), 0 1px 1px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.9), inset 0 -1px 1px rgba(0,0,0,0.1)",
          }}
        />
      </button>
    );
      ...
      >
        {labelSide === "left" && (
          <span className="flex flex-col gap-0.5 text-right">
            <span className="text-xs font-semibold text-white tracking-tight">{label}</span>
            {description && (
