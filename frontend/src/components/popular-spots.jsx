  ...
  const spots = [
    {
      ...
      certifications: ['IFBB Pro Specialist', 'CSCS Certified', 'Biometrics Level 3'],
    ...
    },
    {
      ...
      certifications: ['CrossFit Level 4 Master', 'Olympic Weightlifting Coach'],
    ...
    <section id="locations" className="py-24 px-4 md:px-12 bg-[#090C0E] relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-mono tracking-widest text-[#00F0FF] uppercase">LOCATIONS & COACHING SPOTLIGHT</span>
          <h2 className="text-4xl md:text-6xl font-black font-heading text-white uppercase mt-2">
            ELITE <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2E4C] to-[#00F0FF]">COACHES & CLUBS</span>
          </h2>
        </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            {spots.map((spot) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold font-heading text-white">{spot.locationName}</h3>
          ...
          <div className="lg:col-span-7 bg-[#12161A] rounded-3xl p-8 border border-white/10 flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="flex-1 flex flex-col justify-between h-full">
              <div>
                ...
                <h3 className="text-2xl font-extrabold font-heading text-white">{currentSpot.coachName}</h3>
                <p className="text-xs text-[#00F0FF] font-semibold mt-0.5">{currentSpot.role}</p>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {currentSpot.certifications.map((c, i) => (
                    <span key={i} className="px-2.5 py-1 rounded-lg bg-[#090C0E] border border-white/10 text-[10px] font-mono text-[#8A94A0] flex items-center gap-1">
