...
export default function SplitHoverText({
  ...
  return (
    <div
      className={cn(
        "group relative inline-block max-w-max self-start cursor-pointer select-none overflow-visible",
        className,
      )}
    >
