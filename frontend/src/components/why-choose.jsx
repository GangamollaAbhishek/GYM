  ...
  return (
    <div className="w-full flex flex-col gap-1 select-none">
      <div className="flex justify-between items-center text-xs font-mono text-[#8A94A0] mb-1">
        <span>
          {label}:{" "}
          <strong className="text-white font-bold text-base font-heading">
            {roundedVal} kg
          </strong>
        </span>
...
export default function WhyChoose() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const progress = Math.max(
        0,
        Math.min(1, currentDist / (totalDist * 0.85)),
      );
  ...
  const handleSimulateAI = () => {
    ...
    setTimeout(() => {
      ...
      setGeneratedPlan({
        dailyCalories: isMuscle
          ? Math.round(aiWeight * 36)
          : Math.round(aiWeight * 25),
        protein: `${Math.round(aiWeight * 2.2)}g`,
        carbs: isMuscle
          ? `${Math.round(aiWeight * 4.2)}g`
          : `${Math.round(aiWeight * 2.0)}g`,
        fats: `${Math.round(aiWeight * 0.85)}g`,
        split: isMuscle
          ? "Upper / Lower Power 4-Day Split"
          : "HIIT Circuit & Low-Incline Cardio",
      });
      setSimulating(false);
    }, 600);
  };
      ...
      <div ref={containerRef} className="stack-cards-section">
        ...
        <div className="s__rays">
          <div className="a-rays">
            ...
            >
              <path
                d="M50 0L300 1200M150 0L350 1200M-50 0L200 1200M0 0L250 1200"
        ...
        <div className="stack-viewport">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10 z-10">
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-black font-heading text-white uppercase leading-none tracking-wide">
              WHY WE{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF2E4C] via-white to-[#00F0FF]">
                DOMINATE
              </span>
            </h2>
          </div>
          ...
          <div className="stack-cards-deck">
            {DOMINATE_CARDS.map((card, idx) => {
              ...
              const scaleVal =
                1 - (DOMINATE_CARDS.length - 1 - stackIndex) * 0.035;
                ...
                >
                  ...
                  <div className="card-inner">
                    ...
                    <div className="flex justify-between items-start">
                      <div
                        className={`w-12 h-12 rounded-2xl border flex items-center justify-center shadow-md ${card.iconColor}`}
                      >
                        <IconComp size={24} />
                      </div>
                      <span
                        className={`px-3 py-1 rounded-full border text-[10px] font-mono font-bold flex items-center gap-1.5 shadow-sm ${card.badgeBg}`}
                      >
                        {idx === 1 && (
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="w-full md:max-w-md">
                ...
                <h3 className="text-3xl font-extrabold font-heading text-white mb-3 uppercase">
                  SIMULATE YOUR{" "}
                  <span className="text-[#FF2E4C]">TITAN PLAN</span>
                </h3>
                <p className="text-xs text-[#8A94A0] mb-6 leading-relaxed">
                  Input your target goal and body weight to preview instant
                  AI-calculated macronutrient targets.
                </p>
              ...
              <div className="w-full md:w-1/2 p-6 rounded-2xl bg-[#090C0E] border border-white/10 backdrop-blur-md">
                {generatedPlan ? (
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 my-2">
                      <div className="p-3.5 rounded-xl bg-[#12161A] border border-white/5">
                        <span className="text-[10px] text-[#8A94A0] block font-mono">
                          DAILY CALORIES
                        </span>
                      ...
                      <div className="p-3.5 rounded-xl bg-[#12161A] border border-white/5">
                        ...
                        <span className="text-xl font-extrabold text-[#FF2E4C] font-heading">
                          {generatedPlan.protein}
                        </span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 mb-2">
                      <div className="p-3.5 rounded-xl bg-[#12161A] border border-white/5">
                        ...
                        <span className="text-lg font-bold text-[#00F0FF] font-heading">
                          {generatedPlan.carbs}
                        </span>
                      </div>
                      <div className="p-3.5 rounded-xl bg-[#12161A] border border-white/5">
                        ...
                        <span className="text-lg font-bold text-[#FFB800] font-heading">
                          {generatedPlan.fats}
                        </span>
                      </div>
                    </div>
                    <div className="p-3.5 rounded-xl bg-[#12161A] border border-white/5">
                      <span className="text-[10px] text-[#8A94A0] block font-mono mb-1">
                        RECOMMENDED SPLIT
                      </span>
                  ...
                  <div className="h-56 flex flex-col items-center justify-center text-xs text-[#8A94A0] font-mono text-center gap-2">
                    <Sparkles
                      size={24}
                      className="text-[#FF2E4C] animate-pulse"
                    />
                    <span>
