...
const HorizontalWords = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Timeline for smooth horizontal scrolling + comfortable hold buffer at the end
            const scrollTween = gsap.timeline({
                scrollTrigger: {
                    trigger: container,
                    start: "top top", // Begin pinning when container reaches top
                    end: "+=3200", // Distance over which scroll takes place
                    scrub: 1,
                    pin: true,
                    anticipatePin: 1
                }
        ...
        <section ref={sectionRef} className="horizontal-words-section content-section">
            <div className="horizontal-words__relative">
                <div className="horizontal-words__sticker-svg">
                    ...
                    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="horizontal-words__sticker-watch w-20 sm:w-28 lg:w-32 h-auto filter drop-shadow-[0_0_15px_rgba(229,9,20,0.6)]">
                        <rect x="8" y="32" width="16" height="36" rx="4" fill="#E50914" />
                        <rect x="24" y="24" width="12" height="52" rx="4" fill="#FF2B35" />
                        <rect x="36" y="44" width="28" height="12" rx="3" fill="#FFFFFF" />
                        <rect x="64" y="24" width="12" height="52" rx="4" fill="#FF2B35" />
                        <rect x="76" y="32" width="16" height="36" rx="4" fill="#E50914" />
                    </svg>

                    {/* Gym Sticker 2: Cast Iron Kettlebell SVG */}
                    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="horizontal-words__sticker-cursor w-20 sm:w-28 lg:w-32 h-auto filter drop-shadow-[0_0_15px_rgba(255,43,53,0.6)]">
                        <path d="M30 40 C30 18, 70 18, 70 40" stroke="#FF2B35" strokeWidth="12" strokeLinecap="round" />
                        <circle cx="50" cy="62" r="32" fill="#E50914" />
                        <circle cx="50" cy="62" r="14" fill="#151515" stroke="#FFFFFF" strokeWidth="3" />
                        <text x="50" y="66" textAnchor="middle" fill="#FFFFFF" fontSize="12" fontWeight="900" fontFamily="sans-serif">KG</text>
                    </svg>

                    {/* Gym Sticker 3: Olympic Barbell & Weight Plates SVG */}
                    <svg viewBox="0 0 120 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="horizontal-words__sticker-phone w-24 sm:w-32 lg:w-36 h-auto filter drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">
                        <rect x="10" y="46" width="100" height="8" rx="2" fill="#FFFFFF" />
                        <rect x="22" y="20" width="10" height="60" rx="3" fill="#E50914" />
                        <rect x="34" y="28" width="8" height="44" rx="2" fill="#FF2B35" />
                        <rect x="78" y="28" width="8" height="44" rx="2" fill="#FF2B35" />
                        <rect x="88" y="20" width="10" height="60" rx="3" fill="#E50914" />
