...
const GRID_DATA = [
  ...
  {
    id: 7,
    text: "HYPERBARIC CRYO",
    range: [0.82, 0.98],
    grid: "2 / 3",
    highlight: "highlight-red",
  },
  { id: 8, text: "NITROGEN MATRIX", range: [0.25, 0.42], grid: "2 / 4" },
  { id: 9, text: "CREAPURE®", range: [0.72, 0.9], grid: "3 / 1" },
  {
    id: 10,
    text: "128-NODE TELEMETRY",
    range: [0.65, 0.82],
    grid: "3 / 2",
    highlight: "highlight-cyan",
  },
  // Center Item (Item 11) is the Special Anchor
  {
    ...
    isSpecial: true,
    text: "PULSE FIT",
    sub: "BIOMECHANICAL SUPREMACY",
    range: [0.0, 0.95],
  },
  {
    id: 12,
    text: "ECCENTRIC OVERLOAD",
    range: [0.48, 0.65],
    grid: "3 / 4",
    highlight: "highlight-red",
  },
  { id: 13, text: "PEAK VELOCITY", range: [0.12, 0.28], grid: "4 / 1" },
  { id: 14, text: "SARCOPLASMIC", range: [0.05, 0.2], grid: "4 / 2" },
  {
    id: 15,
    text: "SUB-ZERO FLUSH",
    range: [0.7, 0.88],
  ...
  {
    id: 18,
    text: "ELECTROMAGNETIC RESISTANCE",
    range: [0.38, 0.54],
    grid: "2 / 2",
  },
  {
  ...
  { id: 21, text: "MICRO-FILTERED WHEY", range: [0.1, 0.25], grid: "3 / 1" },
  {
    id: 22,
    text: "BCAA 2:1:1 MATRIX",
    range: [0.06, 0.21],
    grid: "3 / 2",
    highlight: "highlight-red",
  },
  ...
  {
    id: 24,
    text: "POST-ACTIVATION POTENTIATION",
    range: [0.28, 0.45],
    grid: "3 / 4",
    highlight: "highlight-cyan",
  },
  ...
  {
    id: 39,
    text: "350MG CAFFEINE ANHYDROUS",
    range: [0.8, 0.98],
    grid: "3 / 3",
  },
  {
    id: 40,
    text: "6000MG L-CITRULLINE",
    range: [0.18, 0.34],
    grid: "3 / 4",
    highlight: "highlight-red",
  },
  ...
  {
    id: 43,
    text: "DYNAMIC RANGE OF MOTION",
    range: [0.6, 0.78],
    grid: "1 / 3",
  },
  {
    id: 44,
    text: "CELLULAR ATP SATURATION",
    range: [0.02, 0.15],
    grid: "1 / 4",
    highlight: "highlight-red",
  },
