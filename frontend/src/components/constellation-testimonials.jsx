...
const athleteAvatars = [
  {
    ...
    quote:
      "The 3D load engine pushed me past every plateau I held for 3 years. I'm seeing gains every single week!",
  ...
  },
  {
    ...
    quote:
      "Barbell velocity tracking fixed my posture and boosted my total dramatically. What happens if we push to the next tier?",
    timestamp: "Just now",
  },
  {
    id: 3,
    ...
    quote:
      "The sub-zero cryo recovery lab let me train 6 days a week with zero joint soreness.",
  ...
  },
  {
    ...
    quote:
      "TITAN PULSE 3D is not a gym; it is a hyper-performance training laboratory.",
  ...
  },
  {
    ...
    quote:
      "Electromagnetic resistance tuning helped me build lean leg mass twice as fast.",
  ...
  },
  {
    ...
    quote:
      "The elite master trainers refine mechanics during every heavy compound set.",
    timestamp: "Yesterday",
  },
  {
    id: 8,
    ...
    quote:
      "Individualized AI nutrition split turned my recovery into overdrive.",
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 mb-2 pb-2 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="text-xs font-bold font-heading text-white block leading-tight">
              {authorName}
            </span>
            <span className="text-[10px] font-mono text-[#8A94A0] block">
              {timestamp}
            </span>
          </div>
        </div>
        ...
        {visibleAvatars.map((item, index) => {
          ...
          return (
            <div
              ...
              style={{
                zIndex:
                  isHovered || isSelected ? 40 : visibleAvatars.length - index,
              }}
            >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          <span className="text-xs font-mono tracking-widest text-[#00F0FF] uppercase flex items-center justify-center gap-2">
            <Users size={14} className="text-[#FF2E4C]" /> ATHLETE
          ...
          <p className="text-[#8A94A0] text-xs md:text-sm mt-3 font-mono">
            Click any member avatar to display their live Figma-style feedback
            pop-up comment.
          </p>
        </div>
