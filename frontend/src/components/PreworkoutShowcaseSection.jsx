...
export default function PreworkoutShowcaseSection({ onReserveSpot }) {
  ...
  const productsData =
    suppData.products && suppData.products.length > 0
      ? suppData.products
      : DEFAULT_PRODUCTS;
  ...
  return (
    <section
      ref={sectionRef}
      id="preworkout-showcase"
      className="supplement-showcase-section"
    >
          ...
          return (
            ...
            >
              ...
              <div className="showcase__item-img-wrap">
                <span className="showcase__item-badge">
                  {item.badge || `0${index + 1} • ADVANCED`}
                </span>
